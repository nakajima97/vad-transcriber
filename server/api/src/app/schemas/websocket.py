...
class ModelSelectionMessage(BaseWebSocketMessage):
    ...
    type: Literal[WebSocketMessageType.MODEL_SELECTION] = WebSocketMessageType.MODEL_SELECTION
...
class TranscriptionResultMessage(BaseWebSocketMessage):
    ...
    type: Literal[WebSocketMessageType.TRANSCRIPTION_RESULT] = WebSocketMessageType.TRANSCRIPTION_RESULT
...
class TranscriptionErrorMessage(BaseWebSocketMessage):
    ...
    type: Literal[WebSocketMessageType.TRANSCRIPTION_ERROR] = WebSocketMessageType.TRANSCRIPTION_ERROR
...
class TranscriptionSkippedMessage(BaseWebSocketMessage):
    ...
    type: Literal[WebSocketMessageType.TRANSCRIPTION_SKIPPED] = WebSocketMessageType.TRANSCRIPTION_SKIPPED
...
class AudioReceivedMessage(BaseWebSocketMessage):
    ...
    type: Literal[WebSocketMessageType.AUDIO_RECEIVED] = WebSocketMessageType.AUDIO_RECEIVED
...
class SegmentMergeErrorMessage(BaseWebSocketMessage):
    ...
    type: Literal[WebSocketMessageType.SEGMENT_MERGE_ERROR] = WebSocketMessageType.SEGMENT_MERGE_ERROR
    error: str = Field(..., description="エラーメッセージ")
